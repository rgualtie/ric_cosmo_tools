...
with open(dag_script,'a') as f:
    ...
    if pargs.cleanup:
        ...
        f.write('SCRIPT POST spectra_'+os.path.splitext(os.path.basename(pargs.inmap))[0]+'_'+pargs.band+'GHz_nstubs'+pargs.nobs+' /home/'+os.environ.get('USER')+'/src/cleanup_mixmat.sh '+os.path.splitext(os.path.basename(pargs.inmap))[0])
