...
parser.add_argument('--subfield',type=str,default='44.75',
                   help = 'Subfield to be coadded')
...
input_files = glob(grid_path+'/'+mapname+'/ra0hdec-'+pargs.subfield+'/*/'+pargs.band+'GHz/*nstubs'+str(pargs.nobs)+'.g3')
#if not input_files:
#    input_files = []
...
jobname = 'coadd_'+mapname+'_'+pargs.subfield+'_'+pargs.band+'GHz_nstubs'+str(pargs.nobs)
...
if pargs.dag:
    dag_script = os.path.join(condor_dir, jobname+'.dag')
