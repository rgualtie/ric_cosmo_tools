...
# Example call:
# python submit_mapmaker_dag.py --submit --healpix --nside 2048 --band 90
...
cal_files = sort(glob("/sptgrid/analysis/calibration/calframe/ra0hdec-*/*.g3"))
cal_files_no_path = []
for i in cal_files:
    cal_files_no_path.append(i.split('/')[-1])

input_files = sort(glob(data_path+"/ra0hdec-*/*/[!nominal_online_cal]*"))
obsids = []
field = []
