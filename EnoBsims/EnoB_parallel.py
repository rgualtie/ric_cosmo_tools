...
if pargs.submit:
    os.system('python /home/'+os.environ.get('USER')+'/src/submit_EnoB.py --inmap /sptgrid/user/rgualtie/EnoB/'+mapname+'.fits --submit --cleanup --band '+pargs.band+' --band2 '+pargs.band2+' --nobs '+pargs.nobs)
else:
    os.system('python /home/'+os.environ.get('USER')+'/src/submit_EnoB.py --inmap /sptgrid/user/rgualtie/EnoB/'+mapname+'.fits --band '+pargs.band+' --band2 '+pargs.band2+' --nobs '+pargs.nobs)
